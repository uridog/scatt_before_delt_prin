...
if client3.screen_state == 0:
    ...
    while client3.username == "":
        pass
    userInfo = client3.username + " " + client3.password
    ...
    while cmd == "23" or cmd == "24":
        ...
        while client3.username == old_username and client3.password == old_password:
            pass
        userInfo = client3.username + " " + client3.password
        s.send(create_msg(userInfo, "02").encode())
        cmd = handle_cmd(s)
...
while socket_running:
    ...
    while client3.client_ready is False:
        pass
    s.send(create_msg(client3.username, "03").encode())
